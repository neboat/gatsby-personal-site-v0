...
test.each([
    {
        ...
        expected: [
            ...
            { content: 'x', scopeName: ['^variable\.other\.object\.declare'] },
    ...
    },
    {
        ...
        expected: [
            { content: 'int', scopeName: ['^storage\.type'] },
            { content: 'x', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'y', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '7', scopeName: ['^constant\.numeric'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'z', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'y', scopeName: ['^source'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] }
        ]
    },
    {
        ...
        expected: [
            ...
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'y', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'y', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            { content: 'cilk_scope', scopeName: ['^keyword\.control\.cilk'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'cilk_spawn', scopeName: ['^keyword\.control\.cilk'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'value', scopeName: ['^meta\.body\.function'], notScopeName: ['^variable\.other\.object\.declare'] },
            ...
            { content: 'right', scopeName: ['^meta\.body\.function'], notScopeName: ['^variable\.other\.object\.declare'] },
        ]
    },
    {
        langs: ['cilkc', 'cilkcpp'],
        ...
        expected: [
            ...
            { content: 'x', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ':', scopeName: ['^variable\.other\.object\.declare'] }, // TODO: Fix logic for copying scopes
            { content: '1', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'uint8_t', scopeName: ['^storage\.type'] },
            { content: 'y', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ':', scopeName: ['^variable\.other\.object\.declare'] }, // TODO: Fix logic for copying scopes
            { content: '2', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'uint8_t', scopeName: ['^storage\.type'] },
            { content: 'r', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ':', scopeName: ['^variable\.other\.object\.declare'] }, // TODO: Fix logic for copying scopes
            { content: '5', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'] },
            { content: 'uint8_t', scopeName: ['^storage\.type'] },
            { content: 'flags', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
        ]
    },
    {
        ...
        expected: [
            ...
            { content: 'y', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'z', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'int', scopeName: ['^storage\.type'] },
            { content: 'x', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 's', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
        ]
    },
    {
        ...
        expected: [
            ...
            { content: 'u32', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'uint16_t', scopeName: ['^storage\.type'] },
            { content: 'u16', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '[', scopeName: ['^punctuation\.definition\.begin\.bracket\.square', '^meta\.bracket\.square\.access'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '2', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ']', scopeName: ['^punctuation\.definition\.end\.bracket\.square', '^meta\.bracket\.square\.access'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'uint8_t', scopeName: ['^storage\.type'] },
            { content: 'u8', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 's', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '{', scopeName: ['^punctuation\.section\.block\.begin\.bracket\.curly'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '0x', scopeName: ['^keyword\.other\.unit\.hexadecimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '12345678', scopeName: ['^constant\.numeric\.hexadecimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
        ]
    },
    {
        ...
        expected: [
            ...
            { content: 'c', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '[', scopeName: ['^punctuation\.definition\.begin\.bracket\.square', '^meta\.bracket\.square\.access'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '5', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ']', scopeName: ['^punctuation\.definition\.end\.bracket\.square', '^meta\.bracket\.square\.access'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            ...
            { content: 'f', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '//', scopeName: ['^comment\.line\.double-slash'] },
            { content: 'occupies 4 bytes, imposes alignment 4', scopeName: ['^comment\.line\.double-slash'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: 'p', scopeName: ['^variable\.other\.object\.declare', '^meta\.tail\.union'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment', '^meta\.tail\.union'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '{', scopeName: ['^punctuation\.section\.block\.begin\.bracket\.curly'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '.f', scopeName: ['^meta\.block', '^meta\.tail\.union'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '1', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '.', scopeName: ['^constant\.numeric\.decimal\.point'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '23', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
        ]
    },
    {
        ...
        expected: [
            ...
            { content: 's', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: 'T', scopeName: ['^entity\.name\.type\.defined', 'meta\.tail\.struct'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: 'struct', scopeName: ['^storage\.type\.struct'] },
            { content: 'U', scopeName: ['^entity\.name\.type'] },
            { content: '{', scopeName: ['^punctuation\.section\.block\.begin\.bracket\.curly'], notScopeName: ['^entity\.name\.type'] },
            { content: 'T', scopeName: ['^entity\.name\.type\.defined'] },
            { content: 't', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: 'u', scopeName: ['^variable\.other\.object\.declare', 'meta\.tail\.struct'], notScopeName: ['^entity\.name\.type'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
        ]
    },
    {
    ...
    },
    {
        ...
        expected: [
            { content: 'int', scopeName: ['^storage\.type'] },
            { content: 'min', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'a', scopeName: ['^source'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: '<', scopeName: ['^keyword\.operator\.comparison'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare', 'template'] },
            { content: 'b', scopeName: ['^source'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: '?', scopeName: ['^keyword\.operator\.ternary'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: 'a', scopeName: ['^source'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: ':', scopeName: ['^keyword\.operator\.ternary'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: 'b', scopeName: ['^source'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] }
    ...
    },
    {
        ...
        expected: [
            ...
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            { content: 'int', scopeName: ['^storage\.type'] },
            { content: 'res', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'foo', scopeName: ['^entity\.name\.function\.call'], notScopeName: ['^entity\.name\.type', '^variable\.other\.object\.declare'] },
            { content: '<', scopeName: ['^punctuation\.section\.angle-brackets\.begin\.template'] },
            { content: 'A', scopeName: ['^entity\.name\.type'] },
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template'] },
            { content: '(', scopeName: ['^punctuation\.section\.arguments\.begin\.bracket\.round\.function\.call'] },
            { content: 'r', scopeName: ['^source'], notScopeName: ['^variable\.other\.object\.declare'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'a', scopeName: ['^meta\.function\.definition\.body\.lambda'], notScopeName: ['^variable\.parameter', '^variable\.other\.object\.declare'] },
            { content: '<', scopeName: ['^keyword\.operator\.comparison'] },
            { content: 'pivot', scopeName: ['^meta\.function\.definition\.body\.lambda'], notScopeName: ['^variable\.parameter', '^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'end', scopeName: ['^meta\.parens'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '-', scopeName: ['^keyword\.operator\.arithmetic'] },
            { content: 'begin', scopeName: ['^meta\.parens'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '<', scopeName: ['^keyword\.operator\.comparison'] },
            { content: 'BASE_CASE_LENGTH', scopeName: ['^meta\.parens'], notScopeName: ['^variable\.other\.object\.declare'] },
            ...
            { content: '(', scopeName: ['^punctuation\.section\.arguments\.begin\.bracket\.round\.function\.call'] },
            { content: 'begin', scopeName: ['^meta\.block'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter\.comma'] },
            { content: 'end', scopeName: ['^meta\.block'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ')', scopeName: ['^punctuation\.section\.arguments\.end\.bracket\.round\.function\.call'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            { content: '//', scopeName: ['^comment\.line\.double-slash'] },
            ...
            { content: 'T', scopeName: ['^entity\.name\.type\.defined'] },
            { content: '*', scopeName: ['^storage\.modifier\.pointer'] },
            { content: 'middle', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'std', scopeName: ['^entity\.name\.scope-resolution'] },
            { content: '::', scopeName: ['^punctuation\.separator\.scope-resolution'] },
            ...
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter\.comma'] },
            { content: '*', scopeName: ['^keyword\.operator'] },  // TODO: Mark this as a pointer storage-class specifier?
            { content: 'middle', scopeName: ['^meta\.block'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ')', scopeName: ['^punctuation\.section\.arguments\.end\.bracket\.round\.function\.call'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            { content: '//', scopeName: ['^comment\.line\.double-slash'] },
            { content: 'Move pivot to middle', scopeName: ['^comment\.line\.double-slash'] },

            { content: 'cilk_scope', scopeName: ['^keyword\.control\.cilk_scope'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '{', scopeName: ['^punctuation\.section\.block\.begin\.bracket\.curly'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template'] },
            { content: '*', scopeName: ['^storage\.modifier\.pointer'] },
            { content: 'left', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'static_cast', scopeName: ['^keyword\.operator\.cast\.static_cast'] },
            { content: '<', scopeName: ['^punctuation\.section\.angle-brackets\.begin\.template\.call'] },
            { content: 'ostream_view', scopeName: ['^entity\.name\.type\.defined'] },
            ...
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template\.call'] },
            { content: '(', scopeName: ['^punctuation\.section\.parens\.begin\.bracket\.round'] },
            { content: 'left_v', scopeName: ['^meta\.parens', '^meta\.body\.function\.definition'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ')', scopeName: ['^punctuation\.section\.parens\.end\.bracket\.round'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            ...
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template'] },
            { content: '*', scopeName: ['^storage\.modifier\.pointer'] },
            { content: 'right', scopeName: ['^variable\.other\.object\.declare'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'static_cast', scopeName: ['^keyword\.operator\.cast\.static_cast'] },
            { content: '<', scopeName: ['^punctuation\.section\.angle-brackets\.begin\.template\.call'] },
            { content: 'ostream_view', scopeName: ['^entity\.name\.type\.defined'] },
            ...
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template\.call'] },
            { content: '(', scopeName: ['^punctuation\.section\.parens\.begin\.bracket\.round'] },
            { content: 'right_v', scopeName: ['^meta\.parens', '^meta\.body\.function\.definition'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ')', scopeName: ['^punctuation\.section\.parens\.end\.bracket\.round'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },

            { content: 'left', scopeName: ['^variable\.other\.object\.access'], notScopeName: ['^variable\.other\.object\.declare'] },
            ...
            { content: 'right', scopeName: ['^meta\.body\.function\.definition'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: ')', scopeName: ['^punctuation\.section\.arguments\.end\.bracket\.round'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },

            { content: 'right', scopeName: ['^variable\.other\.object\.access'], notScopeName: ['^variable\.other\.object\.declare'] },
            { content: '->', scopeName: ['^punctuation\.separator\.pointer-access'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'Traits', scopeName: ['^entity\.name\.type'] },
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template\.call'] },
            { content: 'm_buffer', scopeName: ['^variable\.other\.object\.declare'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
