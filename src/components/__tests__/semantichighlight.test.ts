...
test.each([
    ...
    },
    {
        ...
        expected: [
            { content: 'int', scopeName: ['^storage\.type'] },
            { content: 'x', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'y', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '7', scopeName: ['^constant\.numeric'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'z', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'y', scopeName: ['^source'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] }
        ]
    },
    {
        ...
        expected: [
            ...
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'y', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'y', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            { content: 'cilk_scope', scopeName: ['^keyword\.control\.cilk'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'cilk_spawn', scopeName: ['^keyword\.control\.cilk'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'value', scopeName: ['^meta\.body\.function'], notScopeName: ['^meta\.definition\.variable\.name'] },
            ...
            { content: 'right', scopeName: ['^meta\.body\.function'], notScopeName: ['^meta\.definition\.variable\.name'] },
        ]
    },
    {
        langs: ['cilkc', 'cilkcpp'],
        ...
        expected: [
            ...
            { content: 'x', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ':', scopeName: ['^meta\.definition\.variable\.name'] }, // TODO: Fix logic for copying scopes
            { content: '1', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'uint8_t', scopeName: ['^storage\.type'] },
            { content: 'y', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ':', scopeName: ['^meta\.definition\.variable\.name'] }, // TODO: Fix logic for copying scopes
            { content: '2', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'uint8_t', scopeName: ['^storage\.type'] },
            { content: 'r', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ':', scopeName: ['^meta\.definition\.variable\.name'] }, // TODO: Fix logic for copying scopes
            { content: '5', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'] },
            { content: 'uint8_t', scopeName: ['^storage\.type'] },
            { content: 'flags', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
        ]
    },
    {
        ...
        expected: [
            ...
            { content: 'y', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'z', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'int', scopeName: ['^storage\.type'] },
            { content: 'x', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 's', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
        ]
    },
    {
        ...
        expected: [
            ...
            { content: 'u32', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'uint16_t', scopeName: ['^storage\.type'] },
            { content: 'u16', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '[', scopeName: ['^punctuation\.definition\.begin\.bracket\.square', '^meta\.bracket\.square\.access'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '2', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ']', scopeName: ['^punctuation\.definition\.end\.bracket\.square', '^meta\.bracket\.square\.access'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'uint8_t', scopeName: ['^storage\.type'] },
            { content: 'u8', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 's', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '{', scopeName: ['^punctuation\.section\.block\.begin\.bracket\.curly'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '0x', scopeName: ['^keyword\.other\.unit\.hexadecimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '12345678', scopeName: ['^constant\.numeric\.hexadecimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
        ]
    },
    {
        ...
        expected: [
            ...
            { content: 'c', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '[', scopeName: ['^punctuation\.definition\.begin\.bracket\.square', '^meta\.bracket\.square\.access'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '5', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ']', scopeName: ['^punctuation\.definition\.end\.bracket\.square', '^meta\.bracket\.square\.access'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            ...
            { content: 'f', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '//', scopeName: ['^comment\.line\.double-slash'] },
            { content: 'occupies 4 bytes, imposes alignment 4', scopeName: ['^comment\.line\.double-slash'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: 'p', scopeName: ['^meta\.definition\.variable\.name', '^meta\.tail\.union'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment', '^meta\.tail\.union'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '{', scopeName: ['^punctuation\.section\.block\.begin\.bracket\.curly'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '.f', scopeName: ['^meta\.block', '^meta\.tail\.union'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '1', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '.', scopeName: ['^constant\.numeric\.decimal\.point'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '23', scopeName: ['^constant\.numeric\.decimal'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
        ]
    },
    {
        ...
        expected: [
            ...
            { content: 's', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: 'T', scopeName: ['^entity\.name\.type\.defined', 'meta\.tail\.struct'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: 'struct', scopeName: ['^storage\.type\.struct'] },
            { content: 'U', scopeName: ['^entity\.name\.type'] },
            { content: '{', scopeName: ['^punctuation\.section\.block\.begin\.bracket\.curly'], notScopeName: ['^entity\.name\.type'] },
            { content: 'T', scopeName: ['^entity\.name\.type\.defined'] },
            { content: 't', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '}', scopeName: ['^punctuation\.section\.block\.end\.bracket\.curly'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: 'u', scopeName: ['^meta\.definition\.variable\.name', 'meta\.tail\.struct'], notScopeName: ['^entity\.name\.type'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
        ]
    },
    {
    ...
    },
    {
        ...
        expected: [
            { content: 'int', scopeName: ['^storage\.type'] },
            { content: 'min', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'a', scopeName: ['^source'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: '<', scopeName: ['^keyword\.operator\.comparison'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name', 'template'] },
            { content: 'b', scopeName: ['^source'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: '?', scopeName: ['^keyword\.operator\.ternary'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: 'a', scopeName: ['^source'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: ':', scopeName: ['^keyword\.operator\.ternary'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: 'b', scopeName: ['^source'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] }
    ...
    },
    {
        ...
        expected: [
            ...
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            { content: 'int', scopeName: ['^storage\.type'] },
            { content: 'res', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'foo', scopeName: ['^entity\.name\.function\.call'], notScopeName: ['^entity\.name\.type', '^meta\.definition\.variable\.name'] },
            { content: '<', scopeName: ['^punctuation\.section\.angle-brackets\.begin\.template'] },
            { content: 'A', scopeName: ['^entity\.name\.type'] },
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template'] },
            { content: '(', scopeName: ['^punctuation\.section\.arguments\.begin\.bracket\.round\.function\.call'] },
            { content: 'r', scopeName: ['^source'], notScopeName: ['^meta\.definition\.variable\.name'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'a', scopeName: ['^meta\.function\.definition\.body\.lambda'], notScopeName: ['^variable\.parameter', '^meta\.definition\.variable\.name'] },
            { content: '<', scopeName: ['^keyword\.operator\.comparison'] },
            { content: 'pivot', scopeName: ['^meta\.function\.definition\.body\.lambda'], notScopeName: ['^variable\.parameter', '^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'end', scopeName: ['^meta\.parens'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '-', scopeName: ['^keyword\.operator\.arithmetic'] },
            { content: 'begin', scopeName: ['^meta\.parens'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '<', scopeName: ['^keyword\.operator\.comparison'] },
            { content: 'BASE_CASE_LENGTH', scopeName: ['^meta\.parens'], notScopeName: ['^meta\.definition\.variable\.name'] },
            ...
            { content: '(', scopeName: ['^punctuation\.section\.arguments\.begin\.bracket\.round\.function\.call'] },
            { content: 'begin', scopeName: ['^meta\.block'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter\.comma'] },
            { content: 'end', scopeName: ['^meta\.block'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ')', scopeName: ['^punctuation\.section\.arguments\.end\.bracket\.round\.function\.call'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            { content: '//', scopeName: ['^comment\.line\.double-slash'] },
            ...
            { content: 'T', scopeName: ['^entity\.name\.type\.defined'] },
            { content: '*', scopeName: ['^storage\.modifier\.pointer'] },
            { content: 'middle', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'std', scopeName: ['^entity\.name\.scope-resolution'] },
            { content: '::', scopeName: ['^punctuation\.separator\.scope-resolution'] },
            ...
            { content: ',', scopeName: ['^punctuation\.separator\.delimiter\.comma'] },
            { content: '*', scopeName: ['^keyword\.operator'] },  // TODO: Mark this as a pointer storage-class specifier?
            { content: 'middle', scopeName: ['^meta\.block'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ')', scopeName: ['^punctuation\.section\.arguments\.end\.bracket\.round\.function\.call'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            { content: '//', scopeName: ['^comment\.line\.double-slash'] },
            { content: 'Move pivot to middle', scopeName: ['^comment\.line\.double-slash'] },

            { content: 'cilk_scope', scopeName: ['^keyword\.control\.cilk_scope'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '{', scopeName: ['^punctuation\.section\.block\.begin\.bracket\.curly'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template'] },
            { content: '*', scopeName: ['^storage\.modifier\.pointer'] },
            { content: 'left', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'static_cast', scopeName: ['^keyword\.operator\.cast\.static_cast'] },
            { content: '<', scopeName: ['^punctuation\.section\.angle-brackets\.begin\.template\.call'] },
            { content: 'ostream_view', scopeName: ['^entity\.name\.type\.defined'] },
            ...
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template\.call'] },
            { content: '(', scopeName: ['^punctuation\.section\.parens\.begin\.bracket\.round'] },
            { content: 'left_v', scopeName: ['^meta\.parens', '^meta\.body\.function\.definition'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ')', scopeName: ['^punctuation\.section\.parens\.end\.bracket\.round'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
            ...
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template'] },
            { content: '*', scopeName: ['^storage\.modifier\.pointer'] },
            { content: 'right', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: '=', scopeName: ['^keyword\.operator\.assignment'] },
            { content: 'static_cast', scopeName: ['^keyword\.operator\.cast\.static_cast'] },
            { content: '<', scopeName: ['^punctuation\.section\.angle-brackets\.begin\.template\.call'] },
            { content: 'ostream_view', scopeName: ['^entity\.name\.type\.defined'] },
            ...
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template\.call'] },
            { content: '(', scopeName: ['^punctuation\.section\.parens\.begin\.bracket\.round'] },
            { content: 'right_v', scopeName: ['^meta\.parens', '^meta\.body\.function\.definition'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ')', scopeName: ['^punctuation\.section\.parens\.end\.bracket\.round'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },

            { content: 'left', scopeName: ['^variable\.other\.object\.access'], notScopeName: ['^meta\.definition\.variable\.name'] },
            ...
            { content: 'right', scopeName: ['^meta\.body\.function\.definition'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: ')', scopeName: ['^punctuation\.section\.arguments\.end\.bracket\.round'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },

            { content: 'right', scopeName: ['^variable\.other\.object\.access'], notScopeName: ['^meta\.definition\.variable\.name'] },
            { content: '->', scopeName: ['^punctuation\.separator\.pointer-access'] },
    ...
    },
    {
        ...
        expected: [
            ...
            { content: 'Traits', scopeName: ['^entity\.name\.type'] },
            { content: '>', scopeName: ['^punctuation\.section\.angle-brackets\.end\.template\.call'] },
            { content: 'm_buffer', scopeName: ['^meta\.definition\.variable\.name'] },
            { content: ';', scopeName: ['^punctuation\.terminator\.statement'] },
